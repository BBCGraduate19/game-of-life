...
function getNeighbourValue(x, y){
	...
	if (!infiniteMode){	
		...
		if (x < 0){	
			return gameBoard[columns + x][y];//if x is negative, adding to total columns will return far right side as neighbour
		} else if (x > columns-1){			
...
function canvasSetup(){
	...
	document.getElementById("statsbar").innerHTML = ("Generation: " + generationCounter + " Live Cells: " + aliveCellCount + " Dead Cells: " + deadCellCount + " Total Cells: " + (deadCellCount+aliveCellCount));
